...
// ChatGPT Preview Mockup Component for first-time users
function ChatGPTPreviewMockup() {
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5 lg:p-6 mb-6">
      ...
      <div className="bg-gray-50 rounded-xl border border-gray-200 p-4">
          ...
          <div className="flex-1">
            ...
            <div className="bg-white rounded-lg p-3 border border-gray-200">
              <p className="text-sm text-gray-700">
                I&apos;m looking for a modern garden studio under &euro;25k that can be delivered in France.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
          ...
          <div className="p-3">
            ...
            <p className="text-[#FA7315] font-bold text-lg mb-1">&euro;19,995</p>
...
// Free Plan Callout Component
function FreePlanCallout() {
  return (
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <ul className="text-sm text-gray-600 space-y-0.5">
            <li>&bull; Publish up to <strong>5</strong> products</li>
            <li>&bull; Full visibility in ChatGPT results</li>
            <li>&bull; Upgrade <strong>anytime</strong> to sync more products</li>
          </ul>
        </div>
      </div>
    </div>
...
export default function ShopsPage() {
  ...
  const isFirstTimeUser = !loading && shops.length === 0;
  ...
  // Auto-open modal for first-time users (coming from registration)
  const autoOpenedRef = useRef(false);
  useEffect(() => {
    if (hydrated && user && isFirstTimeUser && !showConnectModal && !autoOpenedRef.current) {
      autoOpenedRef.current = true;
      setShowConnectModal(true);
    }
  }, [hydrated, user, isFirstTimeUser, showConnectModal]);
        ...
        <div>
          ...
          {loading && shops.length === 0 ? (
            ...
            <div className="space-y-6">
              {/* ChatGPT Preview for first-time users */}
              <ChatGPTPreviewMockup />

              {/* Free Plan Callout for FREE tier */}
              {isFreeTier && <FreePlanCallout />}
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    Connect your WooCommerce store to showcase your products in ChatGPT.
                  </p>
                  <button
